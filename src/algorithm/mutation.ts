 ...
 * #### Example
 * ```typescript
 * import { move } from 'phosphor-core/lib/algorithm/mutation';
 *
 * let data = [0, 1, 2, 3, 4];
 ...
 * #### Example
 * ```typescript
 * import { reverse } from 'phosphor-core/lib/algorithm/mutation';
 *
 * let data = [0, 1, 2, 3, 4];
 ...
 * #### Example
 * ```typescript
 * import { rotate } from 'phosphor-core/lib/algorithm/mutation';
 *
 * let data = [0, 1, 2, 3, 4];
