...
/**
 * A namespace which holds array extension functions.
 */
export
namespace ArrayExt {
  /**
   ...
   */
  export
  function slice<T>(array: T[], start = 0, stop = array.length): IRandomAccessRange<T> {
   ...
   */
  export
  function mutableSlice<T>(array: T[], start = 0, stop = array.length): IMutableRandomAccessRange<T> {
